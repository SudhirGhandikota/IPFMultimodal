...
import numpy as np
import torch
from src.models.pre_training.attentive_pretrain_model import AttnPretrainGNN
...
model = AttnPretrainGNN(hidden_channels=hidden_channels, relations=relations, data=dataset)
...
save_dir = f'saved/pretrain_attn/{args.outdir}/'
if not os.path.exists(save_dir): os.makedirs(f'saved/pretrain_attn/{args.outdir}/')
...
# Usage:
#   python -u pre_train_kg_attn.py --dim_size 32 --num_neg 10.0 --num_epochs 100 --prop_val 0.2 --prop_test 0.2 --patience 10 --outdir gold
#   python -u pre_train_kg_attn.py --dim_size 32 --num_neg 10.0 --num_epochs 100 --prop_val 0.2 --prop_test 0.2 --patience 10 --outdir top_25
#   python -u pre_train_kg_attn.py --dim_size 32 --num_neg 10.0 --num_epochs 100 --prop_val 0.2 --prop_test 0.2 --patience 10 --outdir top_3
