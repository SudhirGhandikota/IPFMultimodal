...
import numpy as np
import torch
from src.models.pre_training.pretrain_model import PretrainGNN
...
save_dir = f'saved/pretrain/{args.outdir}/'
if not os.path.exists(save_dir): os.makedirs(f'saved/pretrain/{args.outdir}/')
...
# Usage:
#   python -u pre_train_kg.py --dim_size 32 --num_neg 10.0 --num_epochs 100 --prop_val 0.2 --prop_test 0.2 --patience 10 --outdir gold
#   python -u pre_train_kg.py --dim_size 32 --num_neg 10.0 --num_epochs 100 --prop_val 0.2 --prop_test 0.2 --patience 10 --outdir top_25
#   python -u pre_train_kg.py --dim_size 32 --num_neg 10.0 --num_epochs 100 --prop_val 0.2 --prop_test 0.2 --patience 10 --outdir top_3
